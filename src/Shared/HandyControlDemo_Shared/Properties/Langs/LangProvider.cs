...
public class LangProvider : INotifyPropertyChanged
{
	...
	OnPropertyChanged(nameof(ConfettiCannon));
	...
	OnPropertyChanged(nameof(MorphingAnimation));
    ...
    /// </summary>
	public string CloseMainWindowDialog => Lang.CloseMainWindowDialog;
    ...
    ///   查找类似 礼炮 的本地化字符串。
    /// </summary>
	public string ConfettiCannon => Lang.ConfettiCannon;
    ...
    ///   查找类似 变形动画 的本地化字符串。
    /// </summary>
	public string MorphingAnimation => Lang.MorphingAnimation;
...
public class LangKeys
{
    ...
    ///   查找类似 关闭主窗口对话框 的本地化字符串。
    /// </summary>
	public static string CloseMainWindowDialog = nameof(CloseMainWindowDialog);
    ...
    ///   查找类似 礼炮 的本地化字符串。
    /// </summary>
	public static string ConfettiCannon = nameof(ConfettiCannon);
    ...
    ///   查找类似 变形动画 的本地化字符串。
    /// </summary>
	public static string MorphingAnimation = nameof(MorphingAnimation);
